const projectsUI = [
  {
    id: 0,
    cover: "/sprites/covers/fruitBox.png",
    mainImage: "/sprites/mainImages/fruitBox.png",
    carouselImages: [
      "/sprites/slidesImg/ui/fruitBox/1.png",
      "/sprites/slidesImg/ui/fruitBox/2.png",
      "/sprites/slidesImg/ui/fruitBox/3.png",
      "/sprites/slidesImg/ui/fruitBox/4.png",
      "/sprites/slidesImg/ui/fruitBox/5.png",
      "/sprites/slidesImg/ui/fruitBox/6.png",
      "/sprites/slidesImg/ui/fruitBox/7.png",
      "/sprites/slidesImg/ui/fruitBox/8.png",
      "/sprites/slidesImg/ui/fruitBox/9.png",
      "/sprites/slidesImg/ui/fruitBox/10.png",
    ],
...
Завдяки лаконічному дизайну вся увага фокусується на яскравих продуктах, а шлях користувача спрощено до мінімуму. У межах проєкту реалізовано інтерфейс із фільтрацією замовлень за тегами, сторінкою доставки з картою та кошиком зі швидкими платежами — усе для простого й комфортного оформлення покупки.`,
  ...
  {
    id: 1,
    cover: "/sprites/covers/sushiBar.png",
    mainImage: "/sprites/mainImages/sushiBar.png",
    carouselImages: [
      "/sprites/slidesImg/ui/sushiBar/1.png",
      "/sprites/slidesImg/ui/sushiBar/2.png",
      "/sprites/slidesImg/ui/sushiBar/3.png",
      "/sprites/slidesImg/ui/sushiBar/4.png",
      "/sprites/slidesImg/ui/sushiBar/5.png",
      "/sprites/slidesImg/ui/sushiBar/6.png",
      "/sprites/slidesImg/ui/sushiBar/7.png",
      "/sprites/slidesImg/ui/sushiBar/8.png",
      "/sprites/slidesImg/ui/sushiBar/9.png",
      "/sprites/slidesImg/ui/sushiBar/10.png",
      "/sprites/slidesImg/ui/sushiBar/11.png",
      "/sprites/slidesImg/ui/sushiBar/12.png",
      "/sprites/slidesImg/ui/sushiBar/13.png",
      "/sprites/slidesImg/ui/sushiBar/14.png",
      "/sprites/slidesImg/ui/sushiBar/15.png",
      "/sprites/slidesImg/ui/sushiBar/16.png",
    ],
...
Створений інтерфейс став ефективним бізнес-інструментом, який максимально спростив та скоротив шлях клієнта до покупки.`,
  ...
  {
    id: 2,
    cover: "/sprites/covers/coffeeBook.png",
    mainImage: "/sprites/mainImages/coffeeBook.png",
    carouselImages: [
      "/sprites/slidesImg/ui/coffeeBook/1.png",
      "/sprites/slidesImg/ui/coffeeBook/2.png",
      "/sprites/slidesImg/ui/coffeeBook/3.png",
      "/sprites/slidesImg/ui/coffeeBook/4.png",
      "/sprites/slidesImg/ui/coffeeBook/5.png",
    ],
    video: `<div style="position: relative; padding-top: 56.25%; width: 100%">
...
Проєкт успішно поєднав атмосферний дизайн та ергономічність, перетворивши пошук столика на швидкий і приємний процес як на десктопі, так і на смартфонах.`,
  ...
  {
    id: 3,
    cover: "/sprites/covers/wonderland.png",
    mainImage: "/sprites/mainImages/wonderland.png",
    carouselImages: [
      "/sprites/slidesImg/ui/wonderland/1.png",
      "/sprites/slidesImg/ui/wonderland/2.png",
      "/sprites/slidesImg/ui/wonderland/3.png",
      "/sprites/slidesImg/ui/wonderland/4.png",
      "/sprites/slidesImg/ui/wonderland/5.png",
    ],
    title: {
