...
const projectsGD = [
  {
    ...
    mainImage: asset(
      "/sprites/mainImages/planetary.png"
    ),
...
Інформаційну архітектуру спроєктовано за принципом архівних карток. Верхній та нижній блоки містять строгу службову структуру (класифікація, параметри атмосфери, координати та опис екосистеми). Це врівноважує художню експресію, додаючи продукту реалістичності та утилітарного вигляду.`,
    ...
    textAnnt: {
      EN: `The project is available on <a href="https://www.behance.net/gallery/246916413/Planetary-Poster-Series-Portfolio-Project" class="typewriter" target="_blank" rel="noopener noreferrer"><span>B</span><span>e</span><span>h</span><span>a</span><span>n</span><span>c</span><span>e</span></a>`,

      UA: `З проектом можна ознайомитися на <a href="https://www.behance.net/gallery/246916413/Planetary-Poster-Series-Portfolio-Project" class="typewriter" target="_blank" rel="noopener noreferrer"><span>B</span><span>e</span><span>h</span><span>a</span><span>n</span><span>c</span><span>e</span></a>`,
    },
...

  {
    ...
    cover: asset(
      "/sprites/covers/sugarFairy.png"
    ),

    mainImage: asset(
      "/sprites/mainImages/sugarFairy.png"
    ),
...
У межах проєкту створено масштабовану систему носіїв фірмового стилю. Дизайн упаковки поєднує фірмову графіку з преміальними методами оздоблення, що підсилює тактильний та візуальний досвід продукту. Для візиток використано лаконічну інформаційну сітку з акцентом на знак та чистоту композиції. Айдентика адаптована й для дрібних утилітарних носіїв — топерів, стрічок та бірок, забезпечуючи впізнаваність бренду на всіх етапах взаємодії. У результаті концепція казкового кондитерського простору трансформувалася у практичний маркетинговий інструмент із високим рівнем візуальної культури.`,
...

  {
    ...
    cover: asset(
      "/sprites/covers/pinGo.png"
    ),

    mainImage: asset(
      "/sprites/mainImages/pingoSushi.png"
    ),
    ...
    title: {
      ...
      UA: "Pingo Sushi\nАйдентика японського ресторану",
    },

    desc: {
      EN: "Pingo Sushi is a visual identity concept for a Japanese cuisine restaurant brand. The identity combines a playful penguin mascot with a bold black-and-red visual system, creating a recognizable and dynamic image for both digital and physical brand applications.",

      UA: "Pingo Sushi — концепція візуальної ідентичності бренду японської кухні. Айдентика поєднує грайливого маскота-пінгвіна зі сміливою чорно-червоною візуальною системою, створюючи впізнаваний та динамічний образ бренду для цифрових і фізичних носіїв.",
    },
...
Масштабування бренду реалізовано через продуману систему паковання. Дизайн екологічних картонних коробок та паперових пакетів і масштабне нанесення маскота покращують User Experience під час анбоксингу.
